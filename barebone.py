...
class BareboneBuilder:
    ...
    def build_kernel(self):
        ...
        fff=f'gcc -c -I./file -L./file -nostdlib ./file/base.c -o /tmp/base.o'
        self.execute_command(fff,True)
        fff=f'nasm -f elf32 "$1" -o /tmp/kernel.o'.replace("$1",filename)
        
        self.execute_command(fff,True)
        self.execute_command("ld  -nostdlib -T ./file/link.ld /tmp/boot.o /tmp/base.o /tmp/kernel.o   -o /tmp/kernel.bin",True)
